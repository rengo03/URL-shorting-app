...
export default function Advanced() {
  return (
    <>
        <section className="bg-gray-100 pt-40 pb-10 h-max lg:pb-40">
            <div className="max-width">
            <h2 className="text-4xl font-bold text-slate-800 mb-3 text-center">Advanced Statistics</h2>
            <p className="text-slate-400 text-center mb-20">Track how your links are performing across the web <br/> with our advanced statistics dashboard</p>
            <div className="relative card grid grid-cols-1 gap-5 md:grid-cols-1 lg:grid-cols-3 ">
