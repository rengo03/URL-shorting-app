...
export default function Footer() {
  return (
    <>
    {/* max-width grid grid-cols-1 gap-5 md:grid-cols-3 lg:grid-cols-5 */}
        <footer className='bg-slate-900 py-10 lg:py-20'>
            <div className='max-width grid grid-cols-1 place-items-center gap-5 md:grid-cols-4 lg:grid-cols-5'>
                <article>
                    <img src={logo} alt=""/>
                </article>
                <article>
